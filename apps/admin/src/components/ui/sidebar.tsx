    ...
    if (isMobile) {
      ...
      return (
        <div className="fixed inset-0 z-50 flex">
          ...
          <div ref={ref} className={cn("relative z-10 flex h-full w-[--sidebar-width] flex-col bg-sidebar overflow-y-auto", className)} {...props}>
            {children}
          </div>
        </div>
      )
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn("inline-flex h-7 w-7 items-center justify-center rounded-md transition-colors hover:bg-accent", className)}
