...
import { Scissors, LayoutDashboard, LogOut, User, Key, ChevronUp, Moon, Sun, Users, FileBarChart, Settings } from "lucide-react";
          ...
          <SidebarContent>
            <SidebarMenu className="px-2 mt-4">
              <SidebarMenuItem>
                <SidebarMenuButton
                  render={
                    <Link to="/dashboard" className="flex items-center gap-2 w-full h-full px-3">
              ...
              <SidebarMenuItem>
                <SidebarMenuButton disabled className="w-full justify-start h-10 px-3 transition-opacity">
          ...
          <SidebarFooter className="p-4 border-t border-border">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent side="top" align="end" className="w-56">
                ...
                <DropdownMenuItem onClick={handleLogout} className="gap-2 text-red-600 focus:text-red-600"><LogOut className="h-4 w-4"/>Logout</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </SidebarFooter>
        </Sidebar>
      ...
      <Sheet open={showPasswordSheet} onOpenChange={setShowPasswordSheet}>
        <SheetContent side="right">
          ...
          <div className="grid gap-4 py-6">
            ...
            <Button className="mt-4" onClick={() => { toast.success("Password diubah (simulasi)"); setShowPasswordSheet(false); }}>Simpan</Button>
          </div>
        </SheetContent>
      </Sheet>
    </SidebarProvider>
